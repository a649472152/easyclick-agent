...
+ (FBApplication *)launchApplicationWithBundleId2:(NSString *)bundleIdentifier
                                      ignoreState:(NSString *)ignoreState
                                        arguments:(nullable NSArray<NSString *> *)arguments
                                      environment:(nullable NSDictionary <NSString *, NSString *> *)environment;
...
+ (BOOL)terminateApplicationWithBundleId2:(NSString *)bundleIdentifier
                              ignoreState:(NSString *)ignoreState;
