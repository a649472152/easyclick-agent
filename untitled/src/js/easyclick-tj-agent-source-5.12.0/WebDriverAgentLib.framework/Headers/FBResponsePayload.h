...
id <FBResponsePayload> FBResponseBinWithObject(id _Nullable object, NSString *contentType);
...
id <FBResponsePayload> FBResponseBinWithStatus(FBCommandStatus *status);
