 ...
 */
- (nullable NSData *)fb_screenshotWithError:(NSError *__autoreleasing *)error compressionQuality:(NSNumber *)compressionQuality;
- (nullable NSData *)fb_screenshotOrzWithError:(NSError *__autoreleasing *)error compressionQuality:(NSNumber *)compressionQuality;
- (nullable NSData *)fb_screenshotOrzWithError2:(NSError *__autoreleasing *)error compressionQuality:(NSNumber *)compressionQuality;

- (nullable UIImage *)fb_screenshotImageWithError:(NSError *__autoreleasing *)error compressionQuality:(NSNumber *)compressionQuality;

- (nullable NSData *)fb_screenshotWithError2:(NSError *__autoreleasing *)error compressionQuality:(NSNumber *)compressionQuality;

- (nullable UIImage *)fb_screenshotImageWithError2:(NSError *__autoreleasing *)error compressionQuality:(NSNumber *)compressionQuality;

- (nullable NSData *)fb_screenshotWithErrorPng:(NSError *__autoreleasing *)error;

- (nullable UIImage *)fb_screenshotWithErrorPngImage:(NSError *__autoreleasing *)error;
...
- (void)cf_swipe:(CGFloat)x1
              y1:(CGFloat)y1 x2:(CGFloat)x2 y2:(CGFloat)y2
           delay:(CGFloat)delay
        pressure:(CGFloat)pressure
...
- (BOOL)fb_performW3CActions:(NSArray *)actions error:(NSError *_Nullable *)error;
