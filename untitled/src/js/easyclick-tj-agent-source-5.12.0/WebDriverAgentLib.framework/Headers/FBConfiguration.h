...
+ (NSString *)urlPrefixAndRouter:(NSString *)api;

+ (NSString *)urlPrefix;

+ (void)setFBURLPrefix:(NSString *)urlPrefix;
...
+ (NSString *)mjpegScreenUrlPrefix;

+ (NSString *)getRandomStr;

+ (NSString *)readBundleFile:(NSString *)fileName ext1:(NSString *)ext;

+ (NSUInteger)toInt:(NSString *)v;

+ (NSUInteger)readPortFile:(NSString *)fileName ext1:(NSString *)ext;

+ (NSInteger)mjpegServerOpen;
 ...
 * 服务端口
 */
+ (void)setServerPort:(NSUInteger)port;

/**
 * 投屏端口
 */
+ (void)setServerScreenPort:(NSUInteger)port;

+ (void)setServerScreenToggle:(NSUInteger)toggle;
